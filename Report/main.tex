...
The final solution which we ended up with, was to take a portion of the user in which group - we chosed 30. Then we found 100 of their followers and added them as nodes (with the user itself) and their friendship as edges. \\
