...
\end{table}
For the friends count metric they have somewhat similar values with the susceptible having a bit higher median and mean, with a high standard deviation indicating outliers.
\begin{table}[ht!]
\begin{tabular}{llllll}
\textbf{}       & Mean    & Median & Std. Dev & Lower Q. & Upper Q. \\
...
\end{table}
The total hashtags metric shows somewhat similar values as well with a bit higher median and mean as well as upper quantile for the susceptible group. This could indicate that the use of hashtags is higher for the susceptible group.
\begin{table}[ht!]
\begin{tabular}{llllll}
\textbf{}       & Mean     & Median & Std. Dev  & Lower Q. & Upper Q. \\
...
To investigate further we create boxplots for the two metrics:\\
\begin{figure}[H]
  \centering
