...
Looking at the follower count (Table \ref{tab:follower_count}), we see an incredibly high standard deviation and high means in comparison to medians for the follower count, this is usually the result of great outliers, that seems to be mostly in the non-susceptible group.
\begin{figure}[H]
  \centering
